...
namespace UnityMCP.Editor.Tools
{
    ...
    public static class TestTools
    {
        ...
        /// </summary>
        [MCPTool("test_echo", "Echoes back the input message - for testing connectivity")]
        ...
        /// </summary>
        [MCPTool("test_add", "Adds two numbers - for testing parameter handling")]
        ...
        /// </summary>
        [MCPTool("test_unity_info", "Returns basic Unity editor information")]
        ...
        /// </summary>
        [MCPTool("test_list_scenes", "Lists all scenes in build settings")]
